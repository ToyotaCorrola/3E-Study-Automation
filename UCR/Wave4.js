function transferWave4SurveyData() {
  var masterSheetId               = '1rLIUGPVviSjAP9P9PwvjDVWyEwfyUxkH3kgN0sn7xkI';
  var w4SheetName                 = 'W4';
  var linkingDestinationSheetId   = '1rwFyG56U6Nt9uPsEs2CoI4sALYg1Tms3QQxM1J7Fvgw';
  var linkingDestinationSheetName = 'Sheet1';
  
  var masterSS = SpreadsheetApp.openById(masterSheetId);
  var w4Sheet = masterSS.getSheetByName(w4SheetName);
  ...
  var masterRange = w4Sheet.getDataRange();
...
*/
  ...
  w4Sheet.getRange(1, 1, masterData.length, masterData[0].length).setValues(masterData);
  w4Sheet.getRange(1, 1, masterBg.length, masterBg[0].length).setBackgrounds(masterBg);
}
